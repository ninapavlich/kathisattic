...
function main() {
    ...
    var override_image_path = "https://kathisattic.s3.amazonaws.com/media/image/icons.png";
    var override_retina_image_path = "https://kathisattic.s3.amazonaws.com/media/image/icons@2x.png";
...
function generateIconBlockSection(items, image, pad_vertical, pad_horizontal){
    var output='                                \
/* THIS FILE IS GENREATED by export_icons.js, do not modify - nina@kathisattic.com */ \
/* ICON BLOCK STYLE */                          \
.icon_block{                                    \
    position:relative;                          \
    pointer-events:none;                        \
...
function generateIconBlockMixin(items, image, pad_vertical, pad_horizontal){
    ...
    var output='                                \
/* THESE MIXINS ARE GENREATED by export_icons.js, do not modify - nina@kathisattic.com */ \
@mixin icon_block() {                               \
    position:relative;                              \
    pointer-events:none;                            \
    display:block;                                  \
...
function generateHTMLExample(items, css_icon_block_path, css_has_sprite_path, css_has_icon_path, css_media_query_path){
    ...
    <body>\
        <!-- THIS FILE IS GENREATED by export_icons.js - nina@kathisattic.com -->\
        <h1>Sprite Sheet</h1>\
