    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_png', models.BooleanField(default=False, help_text=b'Render image as png instead of jpg when possible', verbose_name=b'Use .PNG (instead of .JPG)')),
                ('image', models.ImageField(help_text=b'To ensure a precise color replication in image variants, make sure an sRGB color profile has been assigned to each image.', storage=kathisattic.s3utils._MediaS3BotoStorage(bucket=b'kathisattic', custom_domain=b'kathisattic.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.image_file_name, blank=True)),
                ('file', models.FileField(storage=kathisattic.s3utils._MediaS3BotoStorage(bucket=b'kathisattic', custom_domain=b'kathisattic.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.media_file_name, blank=True)),
