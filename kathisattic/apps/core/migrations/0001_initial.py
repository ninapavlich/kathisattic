    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_source', models.FileField(storage=kathisattic.s3utils._MediaS3BotoStorage(bucket=b'kathisattic', custom_domain=b'kathisattic.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
                ('file_minified', models.FileField(storage=kathisattic.s3utils._MediaS3BotoStorage(bucket=b'kathisattic', custom_domain=b'kathisattic.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
